...
import models.eventflow.Events
...
//      val created = Events.create(title = "MyString", createdAt = DateTime.now, updatedAt = DateTime.now)
...
//    }
    ...
    "perform batch insert" in new AutoRollback {
      val entities = Events.findAll()
      entities.foreach(e => Events.destroy(e))
      val batchInserted = Events.batchInsert(entities)
